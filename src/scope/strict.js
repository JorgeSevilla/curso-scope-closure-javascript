 ...
 * En este modo, se reduce las cosas que podemos hacer, esto es bueno porque permite manejar errores que son poco perceptibles o que el motor de JavaScript 
...
'use strict';
pi = 3.14;
console.log(pi); //Da error por el modo estricto 
